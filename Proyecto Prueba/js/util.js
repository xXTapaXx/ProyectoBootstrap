function addUserAdmin(){
	var arrayUserAdmin = {idUser: "1", nameUser: "Jason", firstNameUser: "Gamboa", lastNameUser: "Solano", dniUser: "207220239", user: "admin", passwordUser: "admin", roleUser: "Administrator"};
...
function modalEditCarrer(){
	...
	$("#btnEdit").click(function(){ editCarrer(nameCarrer) ;});
...
function modalEditUser(){
	...
	$("#btnEdit").click(function(){ editUser(dniUser) ;});
	$("#myModal-Admin").modal("show");
	});
}
...
function modalEditStudent(){
	...
	loadDropDown();
	$("#btnEdit").click(function(){ editStudent(dniStudent) ;});
	$("#myModal-Admin").modal("show");
	});
}
...
function breadcrumbCarrera(){
	var inputPrueba = '<li><a href="">Admin</a><span class="divider"></span></li><li><a href="">Carrera</a><span class="divider"></span>';
	document.getElementById('prueba').innerHTML = inputPrueba;
}

function breadcrumbUsuario(){
	var inputPrueba = '<li><a href="">Admin</a><span class="divider">/</span></li><li><a href="">Carrera</a><span class="divider">/</span><li><a href="">Estudiante</a><span class="divider">/</span></li><li class="active">Usuario</li>';
	document.getElementById('prueba').innerHTML = inputPrueba;
}

function breadcrumbEstudiante(){
	var inputPrueba = '<li><a href="">Admin</a><span class="divider">/</span></li><li><a href="">Carrera</a><span class="divider">/</span></li><li class="active">Estudiante</li>';
	document.getElementById('prueba').innerHTML = inputPrueba;
}
